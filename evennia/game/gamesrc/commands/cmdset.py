...
class CmdSetBlind(CmdSet):
    # Changes the default cmdset for the blind char to remove the look
    # command and add a feel command to replace it.
    self.remove(general.CmdLook())
    self.add(general.CmdFeel())
pass
